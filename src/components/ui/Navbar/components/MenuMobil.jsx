...
export const MenuMobil = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <div className='lg:hidden'>
        ...
        <div className={`drop-shadow-lg fixed flex lg:hidden z-10 w-[250px] h-screen bg-white ${ !isMenuOpen && "transition ease-in-out -translate-x-full duration-300" } left-0 top-0 bottom-5 transition-all duration-300`}>
